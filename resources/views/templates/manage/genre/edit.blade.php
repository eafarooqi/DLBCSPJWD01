        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-12 mb-4">
                    ...
                    <x-form.form :action="route('manage.genres.update', $genre->id)" method="PUT" novalidate hasJsValidation>
                        ...
                        <div class="card shadow-sm components-section">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <x-form.input name="name" :label="__('Name')" :value="$genre->name" required />
                                    </div>
                                </div>
                            </div>
