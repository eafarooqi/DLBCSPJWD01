        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-12 mb-4">
                    ...
                    <x-form.form :action="route('manage.categories.update', $category->id)" method="PUT" novalidate hasJsValidation>
                        ...
                        <div class="card shadow-sm components-section">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <x-form.input name="name" :label="__('Name')" :value="$category->name" required />
                                        <x-form.select name="parent_id" :label="__('Category')" :options="$categoryOptions" :value="$category->parent_id" />
                                    </div>
                                </div>
                            </div>
